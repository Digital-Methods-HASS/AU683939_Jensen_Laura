...
- to color inEdividual country entries consistently, assign the country column to the argument `color`.
...
kings %>% 
  ...
  geom_smooth() +
  labs(title = "The midyear of Danish regents reign")
# YOUR CODE HERE:
```
...
Based on the visualization we have made in this document, I don’t think we can comment on how our civility have changed. We can however say something about how our murderous tendencies have developed over time. The visualizations shows that for all five areas the level of homicides per 100k capita, have fallen over time, except for in Italy who peaked shortly after the first information we have gathered for. We can also see that Italy is the area that has the highest rates of homicides at one point. In England that have always had a rather low homicide rate. All five areas have experienced a significant fall in their homicide rate over time. So if less homicides per capita, equals the societies being more civilized, then it is easy to conclude that the people of Europe have become more civilized over time, and that we are more civilized now than we were in the middle ages. 
I am however very unsure about what our visualization of Danish monarch time of reign, can add to the discussion of whether or not we have become more civilized. I think could have been a different visualization we could make, that would give more insight to that subject. That could have been looking at the age of the monarchs death, because a lot of kings dying young, might indicate regicide, and that is not very civilized. 
